        ...
        <nav class="navbar navbar-expand-lg fixed_top" id="navbar">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent2">
                    ...
                    <div class=" ms-auto">
                        <button onclick="u_logout()" class="btn btn-outline-light" id="u_logout"> <i class="fa fa-sign-out-alt"></i> Logout</button>
                        <script>
                           function u_logout(){
...
<!-- 
        ...
        <div class=" scroll col-2 d-flex">
            ...
            <div class="container main_fri me-auto ms-auto sticky-top">
                <div>
                    <h2 class="h6 pt-4 pb-1 mb-2 border-bottom d-flex">My Progress</h2>
                </div>
